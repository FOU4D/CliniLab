			...
			<div class="card-body">
				<ul class="list-group">
					...
					<li class="list-group-item">
						<i class="la la-plus-square la-lg"></i><strong>Referenced By: </strong>{{$entry->referenced_by}}
					</li>
					@endisset
					<li class="list-group-item">
						<i class="la la-calendar la-lg"></i><strong>Time and Date: </strong>{{$entry->created_at}}
					</li>
				</ul>
			</div>
		</div>
	...
	<div id="visitorinfo" class="col-sm-12 col-md-6">
		<div class="card">
			<div class="card-header bg-blue text-white">
				<i class="la la-barcode la-lg"></i>
				<strong>The Visitor:</strong> {{$entry->individual_id}}
			</div>
			<div class="card-body">
				<ul class="list-group">
					<li class="list-group-item">
						<i class="la la-user la-lg"></i><strong>Name: </strong> <a href="/lab/individual/{{$entry->individual['id']}}/show">{{$entry->individual['name']}}</a>
					</li>
			      @php
                  ...
                  @endphp
					...
					<li class="list-group-item">
						<i class="la la-venus-mars la-lg"></i><strong>Gender: </strong>{{$entry->individual['gender']}}, <i class="la la-calendar la-lg"></i> <strong>Age: </strong>{{$agefzx}} years.
					</li>
				</ul>
			</div>
		</div>
...
<div id="footnotesss" class="row d-flex">
	<div class="col-sm-12 col-md-12">
		<div class="card">
